...
Kittynode is focused on enabling the populace of the digital world (humans and machines) to engage in shaping the world they participate in through voting and consensus. It also enabled participants to enter and exit worlds through their vote.
...
Here is a running list of how the world could change over the next 100 years. I am going to call this section the internet stack of the future, it is a working document area.
...
How does decentralized DNS look? TODO.
