...
There are many work streams to achieve this vision:
...
6. Initiatives that give control over property to the property owners.
7. Educating the people (see: futarchy).
