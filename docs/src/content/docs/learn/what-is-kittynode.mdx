...
Kittynode is a control center for node operators. It is easy to use, and secure by default.

## Kittynode in 2 minutes

A slide deck that explains Kittynode in 2 minutes: [https://hackmd.io/@kittynode/BJpWtod7yl](https://hackmd.io/@kittynode/BJpWtod7yl).
...
<YouTube id="https://youtu.be/zOK7uJDHFCk" />

### Desktop

:::note
This is `kittynode-gui-canary.2`. There is a new version you can see in the mobile demo above, but we didn't get the time to record a video for desktop :)
:::
